    ...
    <main class="max-w-[1000px] mx-auto px-6 mt-10">
        ...
        <div class="bg-[#FAF6ED] rounded-[24px] p-10 shadow-[0_8px_30px_rgba(0,0,0,0.05)] w-full">
            ...
            <div class="border-b-2 border-[#E5DFD3] pb-6 mb-8">
                <h1 class="font-bagh font-bold text-4xl text-[#1F1F1F]">Tambah Cafe Baru</h1>
                <p class="text-[#716353] mt-2 font-medium">Lengkapi data di bawah ini untuk mendaftarkan cafe ke dalam sistem.</p>
            </div>

            <form method="POST" action="{{ route('admin.cafes.store') }}" enctype="multipart/form-data" class="flex flex-col gap-8">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" required class="w-full bg-white border border-[#D1C9BB] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FDBA21] focus:border-transparent transition-all shadow-sm">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="deskripsi_singkat" value="{{ old('deskripsi_singkat') }}" placeholder="Contoh: Tempat nyaman buat nugas..." class="w-full bg-white border border-[#D1C9BB] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FDBA21] transition-all shadow-sm placeholder-gray-400">
                        </div>
                        ...
                        <div class="flex flex-col gap-3 mt-2">
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                <label class="flex items-center gap-2 cursor-pointer bg-white border border-[#D1C9BB] px-4 py-2 rounded-lg hover:border-[#FDBA21] transition-colors has-[:checked]:bg-[#FDBA21]/10 has-[:checked]:border-[#FDBA21]">
                                    <input type="checkbox" name="categories[]" value="{{ $category->id }}" class="w-4 h-4 text-[#FDBA21] focus:ring-[#FDBA21] rounded border-gray-300">
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" name="phone" value="{{ old('phone') }}" placeholder="0812-xxxx-xxxx" class="w-full bg-white border border-[#D1C9BB] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FDBA21] transition-all shadow-sm placeholder-gray-400">
                        </div>

                        <div class="flex flex-col gap-2">
                            <label class="font-bold text-[#4A3B2C]">Sosial Media (Instagram)</label>
                            <input type="text" name="sosmed" value="{{ old('sosmed') }}" placeholder="@akun_cafe" class="w-full bg-white border border-[#D1C9BB] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FDBA21] transition-all shadow-sm placeholder-gray-400">
                        </div>

                        <div class="grid grid-cols-2 gap-4">
                            <div class="flex flex-col gap-2">
                                <label class="font-bold text-[#4A3B2C]">Jam Operasional</label>
                                <input type="text" name="open_hours" value="{{ old('open_hours') }}" placeholder="08.00 - 22.00" class="w-full bg-white border border-[#D1C9BB] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FDBA21] transition-all shadow-sm placeholder-gray-400">
                            </div>
                            <div class="flex flex-col gap-2">
                                ...
                                <select name="price_range" class="w-full bg-white border border-[#D1C9BB] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FDBA21] transition-all shadow-sm">
                                    ...
                                    <option value="Murah" {{ old('price_range') == 'Murah' ? 'selected' : '' }}>Murah</option>
                                    <option value="Sedang" {{ old('price_range') == 'Sedang' ? 'selected' : '' }}>Sedang</option>
                                    <option value="Mahal" {{ old('price_range') == 'Mahal' ? 'selected' : '' }}>Mahal</option>
                                </select>
                ...
                <div class="flex flex-col gap-5 mt-2">
                    <div class="flex flex-col gap-2">
                        ...
                        <textarea name="address" required rows="2" placeholder="Jl. Contoh No. 123..." class="w-full bg-white border border-[#D1C9BB] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FDBA21] transition-all shadow-sm resize-none">{{ old('address') }}</textarea>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <textarea name="description" rows="4" placeholder="Ceritakan detail tentang suasana, menu andalan, fasilitas cafe..." class="w-full bg-white border border-[#D1C9BB] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#FDBA21] transition-all shadow-sm resize-none">{{ old('description') }}</textarea>
                    </div>
                </div>

                <div class="flex flex-col gap-2">
                    <label class="font-bold text-[#4A3B2C]">Foto Cafe</label>
                    <div class="w-full border-2 border-dashed border-[#D1C9BB] rounded-xl p-8 flex flex-col items-center justify-center bg-white/50 hover:bg-white transition-colors">
                        ...
                        <p class="text-xs text-gray-400 mt-2">Format yang didukung: JPG, PNG (Max 2MB)</p>
                    </div>
